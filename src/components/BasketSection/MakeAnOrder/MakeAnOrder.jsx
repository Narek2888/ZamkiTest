          ...
          <div className="makeAnOrder__up__section__input">
            ...
            <div className="makeAnOrder__up__section__input__deliveryMethods">
              ...
              <div className="makeAnOrder__up__section__input__deliveryMethods__button">
                <button className="makeAnOrder__up__section__input__deliveryMethods__button__btn">Самовывоз</button>
                <button className="makeAnOrder__up__section__input__deliveryMethods__button__btn">Доставка в пределах мкад</button>
                <button className="makeAnOrder__up__section__input__deliveryMethods__button__btn">Доставка за мкад</button>
              </div>
            </div>

            <div className="makeAnOrder__up__section__input__comment">
                <p className="makeAnOrder__up__section__input__comment__text">Комментарии к заказу </p>
