    ...
    <div>
      <div className="delivery">
        ...
        <div className="delivery__text">
          ...
          <ul>
            <li>
              Работа с НДС, оформление документов для бухгалтерской отчетности.
            </li>
            <li>
            ...
            <li>
              Регулярные акции с выгодными предложениями для ограниченного круга
              оптовых заказчиков.
            </li>
          ...
          зонами погрузки.
          <p className="padding">
            Сотрудничество с компанией «Замки тут» - это удобно и выгодно. Наши
            преимущества:
          </p>
          <ul>
            <li>
            ...
            <li>
              Сервис. Мы заинтересованы в оптовых клиентов. Гарантируем высокую
          ...
          <p className="padding">
            {" "}
            По вопросам сотрудничества позвоните нам по телефону, указанному на
            сайте. Мы также готовы обсуждать условия оптовых поставок в нашем
            офисе в Москве на личной консультации.
          </p>
        </div>
      </div>
      <Manufacturers />
